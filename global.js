...
module.exports = {
  development: {
    dataurl: function(){
      return 'http://reportapi.uat.emapd.com/'
    },
    quoteurl: function(){
      return 'http://push2.eastmoney.com/'
    },
    quotehisurl: function(){
      return 'http://push2his.eastmoney.com/'
    },
    dcfmurl: function(){
      return 'http://dcfm.eastmoney.com/'
    },
    datacenter: function(){
      return 'http://datacenter.eastmoney.com/'
    },
    datainterface: function(){
      return 'http://datainterface.eastmoney.com/'
    },
    datainterface3:function(){
      return 'http://datainterface3.eastmoney.com/'
    },
    soapi: function(){
      return 'http://searchapi.eastmoney.com/'
    },
    url: function(){
      return ''
    }
  ...
  zptest: {
    ...
    datacenter: function(){
      return 'http://testdatacenter.eastmoney.com/'
    },
    datainterface: function(){
      return 'http://datainterface.eastmoney.com/'
    },
  ...
  production: {
    ...
    cmsdataapi: function(){
      return 'http://cmsdataapi.eastmoney.com/'
    },
    url: function(){
      return ''
    }
